...
CONFIG = {
    ...
    "api_max_retries": 1,
    "results_csv": Path("results_llama32_bo3.csv"),
    "save_injected_images": False,
    "injected_images_dir": Path("injected_images_llama32_bo3"),
}
...
def run_experiment(cfg: dict | None = None) -> None:
    ...
    print("Model: llama3.2 vision local")
    ...
    with open(results_path, "w", newline="", encoding="utf-8") as f:
        ...
        for trial in tqdm(trial_plan, desc="Llama32 BO3", unit="trial"):
