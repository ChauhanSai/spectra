...
def ensure_leaf_folder(word, placement, contrast):
    leaf = os.path.join(
        OUTPUT_ROOT,
        word,
        placement,
    ...
    for idx, img_name in enumerate(image_names):
        ...
        for word in TARGET_WORDS:
            ...
            for placement_name, (row, col) in placements:
                for contrast_name in CONTRAST_LEVELS:
                    ...
                    attacked = draw_text_in_cell(
                        ...
                        contrast_level=contrast_name
                    )

                    out_dir = ensure_leaf_folder(
                        word, placement_name, contrast_name
                    )
